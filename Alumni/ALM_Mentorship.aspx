...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-custom">
        ...
        <div class="Mentorship-program my-5 style1 mt-15">

            <div class="notice-bord notice-bord-page style1 ovrflw">
                <h4 class="title">Welcome to the Mentorship Program. Choose your role to proceed.</h4>
            </div>

            <div class="row">

                <div class="col-sm-6">
                    <div class="card card-box text-center p-20">
                        <h5 class="fw-bold">Become a Mentor</h5>
                        <p>Guide and support others by becoming a mentor.</p>
                        <Anthem:Button ID="btnBecomeMentor" runat="server" CssClass="readon2 mt-10" SkinID="none" Text="Become a Mentor" OnClick="btnBecomeMentor_Click" AutoUpdateAfterCallBack="true" Style="cursor: pointer;" />
                    </div>
                </div>

                <div class="col-sm-6">
                    <div class="card card-box text-center p-20">
                        <h5 class="fw-bold">Become a Mentee</h5>
                        <p>Learn and grow under experienced mentors.</p>
                        <Anthem:Button ID="btnBecomeMentee" runat="server" CssClass="readon2 mt-10" SkinID="none" Text="Become a Mentee" OnClick="btnBecomeMentee_Click" AutoUpdateAfterCallBack="true" Style="cursor: pointer;" />
                    </div>
                </div>
            ...
            <Anthem:LinkButton ID="lnkAdminMentorshipRequest" runat="server" AutoUpdateAfterCallBack="true" OnClick="lnkAdminMentorshipRequest_Click" data-toggle="modal" data-target="#modalPopUpMentorRequestMsgss" class="alert-link text-dark">
                                       <i class="fa-solid fa-messages"></i> Click here to view mentorship request details.
            </Anthem:LinkButton>
        </div>--%>

            <div class="alert alert-success mt-15" style="display: none;">
                <strong><i class="fa fa-bell-o"></i>Notification Alert :- </strong>
                <Anthem:LinkButton ID="lnkMenteeRequestedV" runat="server" AutoUpdateAfterCallBack="true" OnClick="lnkMenteeRequestedV_Click" data-toggle="modal" data-target="#modalPopUpMenteeRequestMsgss" class="alert-link text-dark">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="dashboard custom-mentor-dashboard mt-15" oncontextmenu="return false;">
                    <div class="card bg-gradient-danger custom-bg-gradient-danger card-img-holder text-white m-0">
                        <div class="card-body">
                            <img src="../img/circle.png" class="card-img-absolute" alt="circle-image">
                            <i class="fa fa-users card-img-absolute" aria-hidden="true"></i>
                            <h2 class="font-weight-normal mb-3 text-white">Total Mentors </h2>
                            ...
                            <h6 class="card-text">
                                <a id="lnkViewAllMentors" href="ALM_Mentors_ViewAll.aspx?type=mentor" runat="server">View All</a>
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="dashboard custom-mentor-dashboard mt-15" oncontextmenu="return false;">
                    <div class="card bg-gradient-info custom-bg-gradient-info card-img-holder text-white m-0">
                        <div class="card-body">
                            <img src="../img/circle.png" class="card-img-absolute" alt="circle-image">
                            <i class="fa fa-users card-img-absolute" aria-hidden="true"></i>
                            <h2 class="font-weight-normal mb-3 text-white">Total Mentees </h2>
                            <h2 class="mb-5 text-white text-shadow">
                                <Anthem:Label ID="lblCountMentees" runat="server" AutoUpdateAfterCallBack="true"></Anthem:Label>
                            </h2>
                            <h6 class="card-text">
                                <a id="lnkViewAllMentees" href="ALM_Mentees_ViewAll.aspx?type=mentee" runat="server">View All</a>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard custom-mentor-dashboard mt-15" oncontextmenu="return false;">
                    <div class="card bg-gradient-danger-2 card-img-holder text-white m-0" style="min-height: 174px;">
                        <div class="card-body">
                            ...
                            <h2 class="font-weight-normal mb-3 text-white">Mentorship Homepage </h2>
                            <h2 class="mb-5 text-white text-shadow">
                                <Anthem:Label ID="lblCountMentorshipHomepage" runat="server" AutoUpdateAfterCallBack="true" Text=""></Anthem:Label>
                                &nbsp;
                            </h2>
                            <h6 class="card-text">
                                <a id="lnkMentorshipHomepage" href="ALM_MentorshipHomepage.aspx" runat="server">Click here </a>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard custom-mentor-dashboard mt-15">
                    <div class="card bg-gradient-success custom-bg-gradient-success card-img-holder text-white m-0" style="min-height: 174px;">
                        <div class="card-body">
                            ...
                            <h2 class="font-weight-normal mb-3 text-white">My Preferences </h2>
                            <h2 class="mb-5 text-white text-shadow">
                                <Anthem:Label ID="lblCountMyPreferences" runat="server" AutoUpdateAfterCallBack="true" ToolTip=""></Anthem:Label>
                                &nbsp;
                            </h2>
                            <h6 class="card-text">
                                <a id="lnkMyPreferences" href="ALM_MyPreferences.aspx" runat="server">Click here </a>
                            </h6>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal" id="modalPopUpMentorRequestMsgss" oncontextmenu="return false;">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="modalheaderTitleMR">Admin Requested for Mentorship Messages </h5>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card" id="Div2" runat="server">
                        <!-- Message History -->
                        <Anthem:Repeater ID="Repeater1" runat="server" AutoUpdateAfterCallBack="true" OnItemCommand="rptMRM_ItemCommand">
                            <ItemTemplate>
                                <div class="message-box" onclick="setSelectedIDs('<%# Eval("senderID") %>', '<%# Eval("pk_MRID") %>')">
                                    <div class="message-header">Mentorship For : </div>
                                    <div class="message-body"><%# Eval("seekingHelpFor") %> </div>
