<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_StoriessDetails.aspx.cs" Inherits="Alumni_ALM_StoriessDetails" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="page-title">Stories Details </h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div style="float: right;">
                        <a class="readon2 banner-style" href="ALM_View_All_Storiess.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i>Back</a>
                    </div>
                </div>
            </div>
        </div>
