<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="Alm_NewsandEvents_pors.aspx.cs" Inherits="Alumni_Alm_NewsandEvents_pors" %>
            ...
            <div class="row">
                        ...
                        <ItemTemplate>
                            <div>
                                <div class="single-image">
                                    <img runat="server" id="Imge" src='<%# Eval("ImageUrl")%>' alt="">
                                </div>
                ...
                <div class="col-md-4">
                    <div style="float: right;">
                        <a class="readon2 banner-style" href="Alm_NewsandStoriesList.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i>Back</a>
                    </div>
                </div>
