<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ALM_Fund_Donation.aspx.cs" Inherits="Alumni_ALM_Fund_Donation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function checkValidation() {
            ...
            if (document.getElementById('ctl00_ContentPlaceHolder1_mobile').value == "") {
                alert("Mobile can not be blank!.")
                document.getElementById('ctl00_ContentPlaceHolder1_mobile').focus();
                return false;
            } else if (document.getElementById('ctl00_ContentPlaceHolder1_mobile').value.length < 10) {
                alert("Invalid Mobile No!");
                getElementById('ctl00_ContentPlaceHolder1_mobile').focus();
                return false;
            }
        }
                        ...
                        <ItemTemplate>
                            <div>
                                <div class="single-image">
                                    <img id="Imge" src='<%# Eval("FilePath") %>' width="100%" style="height:400px;" alt="event">
                                </div>
                                ...
                                <form id="contact-form" method="post" action="#">
                                    <fieldset>
                                        ...
                                        <div class="form-group form-check mb-0">
                                            ...
                                            <label class="form-check-label" id="CheckAnonymous" for="exampleCheck1">Make Anonymously</label>
                                        </div>
                                        <p>*By disclosing your name, you are likely to encourage others to donate.</p>
                                        <div class="form-group mt-1">

                                            <%--<Anthem:Button ID="donate" runat="server" class="btnConDonate" OnClick="donate_Click" Text="Donate Now" AutoUpdateAfterCallBack="true" OnClientClick="this.style.display='none';document.getElementById('contribute').style.display = 'block'" />--%>
                                            ...
                                            <Anthem:Button ID="donate" runat="server" AutoUpdateAfterCallBack="true" OnClick="donate_Click" class="btn-sm btnConDonate" OnClientClick="return checkValidation();" Text="Donate Now" />
