<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_Alumni_Publish_Internships.aspx.cs" Inherits="Alumni_ALM_Alumni_Publish_Internships" %>
                    ...
                    <div class="panel-body pnl-body-custom">
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                ...
                                <label id="lblVacancyDtl" class="col-sm-2  control-label custom-text-right">Internship Details : </label>
                                <div class="col-sm-3 required">
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                <label id="lblJobVacncyUrl" class="col-sm-2  control-label custom-text-right">Internship URL : </label>
                                <div class="col-sm-3 required">
                                    <Anthem:TextBox ID="txt_JobVacncyUrl" runat="server" MaxLength="100" CssClass="form-control"
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                <label id="lblStartDate" class="col-sm-2  control-label custom-text-right">Start Date : </label>
                                <div class="col-sm-3 required custom-cal">
                                    <Anthem:TextBox ID="V_txtStartDate" runat="server" AutoUpdateAfterCallBack="True" onpaste="return false;" ondrag="return false;" ondrop="return false;" MaxLength="10" onkeydown="return false" CssClass="form-control" TabIndex="8" Width="128px"></Anthem:TextBox>
                                ...
                                <label id="lblEndDate" class="col-sm-2  control-label custom-text-right">End Date : </label>
                                <div class="col-sm-3 required custom-cal">
                                    <Anthem:TextBox ID="V_txtEndDate" runat="server" AutoUpdateAfterCallBack="True" onpaste="return false;" ondrag="return false;" ondrop="return false;" MaxLength="10" onkeydown="return false" CssClass="form-control" TabIndex="9" Width="128px"></Anthem:TextBox>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                <label id="lblStipend" class="col-sm-2  control-label custom-text-right">Stipends : </label>
                                <div class="col-sm-3 required">
                                    <Anthem:TextBox ID="txtStipend" runat="server" MaxLength="5" CssClass="form-control" AutoUpdateAfterCallBack="true" Style="width: 95% !important;" TabIndex="5"></Anthem:TextBox>*
                                </div>
                                <label id="lblDuration" class="col-sm-2  control-label custom-text-right">Duration : </label>
                                <div class="col-sm-3 required">
                                    <Anthem:TextBox ID="txtDuration" runat="server" MaxLength="2" CssClass="form-control" AutoUpdateAfterCallBack="true" Style="width: 95% !important;" TabIndex="6"></Anthem:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-2">
                                    <Anthem:Button ID="btnSave" runat="server" Text="PUBLISH" OnClick="btnSave_Click" CommandName="SAVE" AutoUpdateAfterCallBack="true" PreCallBackFunction="btnSave_PreCallBack" CausesValidation="false" EnableCallBack="false" />
                                    &nbsp;&nbsp;
                    ...
                    <div class="table-responsive">
                        ...
                        <Anthem:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False" Width="100%" AutoUpdateAfterCallBack="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Internship Details" DataField="VacancyDtl" />
                                <asp:BoundField HeaderText="Start Date" DataField="JobOpenFrom" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="End Date" DataField="JobOpenTo" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:TemplateField HeaderText="Internships Status">
                                ...
                                <asp:TemplateField HeaderText="EDIT">
                                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <Anthem:LinkButton ID="lnkEdit" Visible='<%#Convert.ToString(Eval("IsApprovedByPCell")).Length>0?false:true %>' runat="server" CssClass="DataGriditemLink" CommandName="SELECT" CommandArgument='<%# Eval("pk_InternshipId") %>'>
