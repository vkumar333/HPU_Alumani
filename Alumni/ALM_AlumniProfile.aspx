<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_AlumniProfile.aspx.cs" Inherits="Alumni_ALM_AlumniProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <div class="back-btn-custom pull-right">
                            <%--<a href='<%# string.Format("~/Alumni/ALM_AlumniProfile_Search.aspx?ID={0}", HttpUtility.UrlEncode(Eval("encId").ToString())) %>' class="btn-block">
                                <i class="fa fa-arrow-left" aria-hidden="true"></i>Back 
                            </a>--%>

                            <asp:HyperLink ID="lnkBack" runat="server" CssClass="btn btn-warning btn-sm back-button pull-right" NavigateUrl="~/Alumni/ALM_AlumniSearch.aspx">
                                <i class="fa fa-arrow-left" aria-hidden="true"></i> Back
                            </asp:HyperLink>
                        </div>
                    </div>
    ...
    <main>
        ...
        <div class="container" style="margin-bottom:30px;">
            <div class="row">
                <div class="col-lg-3 order-2 order-lg-1" style="margin-bottom:30px;">
