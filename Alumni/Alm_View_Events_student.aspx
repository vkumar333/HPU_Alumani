<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="Alm_View_Events_student.aspx.cs" Inherits="Alumni_Alm_View_Events_student" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div style="border: 1px solid #e1e1e1; padding: 15px;">
                        ...
                        <div class="mb-30">
                            ...
                            <a id="anchorEventLink" name="anchor" runat="server"></a>
                            <br />
                            <br />
                        ...
                        <div class="mb-20">
                            <asp:LinkButton ID="btnEventLike" class="like-btn btn-default btn-xs" runat="server" OnClick="btnEventLike_Click">
                                <i class="fa fa-thumbs-up"></i>&nbsp;
                                <asp:Label ID="lblEventLikesCount" runat="server" Text=""></asp:Label>
                            </asp:LinkButton>
                        </div>
                        ...
                        <div class="" style="border: 1px solid #e1e1e1; padding: 15px;">
                            <div class="be-comment-block">
                                ...
                                <div class="be-comment">
                                    <asp:Repeater ID="rptEventComments" runat="server">
                                        <ItemTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtEventComment" class="form-input" AutoUpdateAfterCallBack="true" runat="server" placeholder="Add a comment"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <asp:Button ID="btnEventComment" runat="server" Text="Comment" OnClick="btnEventComment_Click" class="back-btnn pull-right" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-1 col-md-12" style="margin-top: 15px;">
                    <div class="back-btn">
                        <a href="Alumni_NewsEvents_View.aspx">Back</a>
                    </div>
                </div>
            </div>
        </div>
