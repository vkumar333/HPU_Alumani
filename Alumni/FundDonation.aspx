<%@ Page Title="" Language="C#" MasterPageFile="~/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="FundDonation.aspx.cs" Inherits="Alumni_FundDonation" %>
                                ...
                                <form id="contact-form"  method="post" action="#">
                                    <fieldset>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <%--<input name="fname" id="fname" runat="server" class="form-control" type="text" placeholder="INR">--%>
                                                     <Anthem:TextBox runat="server" ID="Txt_Amount" class="form-control" placeholder="INR"></Anthem:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                 ...
                                                 <%--   <input name="lname" id="lname" runat="server" class="form-control" type="text" placeholder="Name">--%>
                                                    <Anthem:TextBox runat="server" ID="txtname" class="form-control" placeholder="Name"></Anthem:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label>Email*</label>
                                                    <Anthem:TextBox runat="server" ID="Textemail" class="form-control" placeholder="Email"></Anthem:TextBox>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <Anthem:TextBox runat="server" ID="mobile" class="form-control" placeholder="Mobile Number"></Anthem:TextBox>
                                        ...
                                        <div class="form-group mt-1">
                                            <Anthem:Button runat="server" ID="donate" AutoUpdateAfterCallBack="true" OnClick="donate_Click" class="readon2 banner-style ext btn-send" Text="Donate Now" />
