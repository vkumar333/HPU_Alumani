<%@ Page Title="" Language="C#" MasterPageFile="../AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_StoriesDetails.aspx.cs" Inherits="Alumni_ALM_StoriesDetails" %>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div style="float: right;">
                        <a class="readon2 banner-style" href="ALM_View_All_Stories.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i>Back</a>
                    </div>
                </div>
            </div>
        </div>
