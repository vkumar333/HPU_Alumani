<%@ Page Title="" Language="C#" MasterPageFile="~/UMM/MasterPage.master" AutoEventWireup="true" CodeFile="ALM_Publish_Internships_Approval.aspx.cs" Inherits="Alumni_ALM_Publish_Internships_Approval" %>
            ...
            <div class="box box-success">
                <div class="box-body table-responsive">
                    <table class="table mobile_form">
                        <tr>
                            <td colspan="4" class="tableheading">Manage Internships</td>
                        </tr>
                        <tr>
                            <td colspan="4" class="tdgap"></td>
                        </tr>
                        <tr>
                            <td colspan="4" class="tablesubheading">List of Pending Internships for Approval 
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <div class="gridiv">
                                    <Anthem:GridView ID="gvDetails" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                        AutoUpdateAfterCallBack="True" DataKeyNames="pk_InternshipId" EnableCallBack="false" Width="100%"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No.">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <Anthem:HiddenField ID="hdncompanyid" runat="server" Value='<%# Eval("pk_InternshipId") %>' />
                                                    <Anthem:Label ID="txtCompanyReqId" runat="server" Visible="false" Text='<%# Eval("pk_InternshipId").ToString() %>'></Anthem:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="JobOpenFrom" HeaderText="Apply Date">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:BoundField>
                                            <asp:BoundField DataField="JobOpenTo" HeaderText="Last Date for Applying for a Internship">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField HeaderText="Details">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <Anthem:LinkButton runat="server" ID="lnkView1" Text="View" CausesValidation="False" CommandArgument='<%# Eval("pk_InternshipId") %>'
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <Anthem:Button runat="server" CssClass="btn btn-primary btn-sm" ID="btnSubmit" Text="DONE" CausesValidation="False" CommandArgument='<%# Eval("pk_InternshipId") %>'
            ...
            <div class="box box-success">
                <div class="box-body table-responsive">
                    <table class="table mobile_form">
                        ...
                        <tr>
                            <td colspan="4" class="tablesubheading">List of Approved Internships</td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <Anthem:GridView ID="gvApprovedJobs" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoUpdateAfterCallBack="True" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Details">
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                            <ItemTemplate>
                                                <Anthem:LinkButton runat="server" ID="lnkViewApproved" Text="View" CausesValidation="False" CommandArgument='<%# Eval("pk_InternshipId") %>'
                        ...
                        <tr>
                            <td colspan="4" class="tablesubheading">List of Rejected Internships</td>
                        </tr>
                        <tr>
                            <td colspan="4" class="tdgap"></td>
                        </tr>
                            ...
                            <td colspan="4">
                                <div class="gridiv">
                                    <Anthem:GridView ID="gvRejectedJobs" runat="server" EnableCallBack="false" AllowPaging="True" AutoGenerateColumns="False"
                                        AutoUpdateAfterCallBack="True" DataKeyNames="pk_InternshipId" Width="100%" OnPageIndexChanging="gvRejectedJobs_PageIndexChanging"
                                        UpdateAfterCallBack="True">
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No.">
                                                <ItemStyle HorizontalAlign="Center" Width="5%" />
                                            ...
                                            <asp:TemplateField HeaderText="Details">
                                                <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                <ItemTemplate>
                                                    <Anthem:LinkButton runat="server" ID="lnkView2" Text="View" CausesValidation="False" CommandArgument='<%# Eval("pk_InternshipId") %>'
