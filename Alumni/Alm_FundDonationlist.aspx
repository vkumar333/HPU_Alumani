<%@ Page Title="" Language="C#" MasterPageFile="~/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="Alm_FundDonationlist.aspx.cs" Inherits="Alumni_FundDonationlist" %>
                            ...
                            <div class="col-md-4">
                                <div class="evnets-item-shadow">
                                    ...
                                    <div class="course-body">
                                        <asp:HyperLink runat="server" class="readon2 banner-style ext ext-page mt-10" NavigateUrl='<%# string.Format("~/Alumni/Alm_FundDonation.aspx?ID={0}", HttpUtility.UrlEncode(Eval("encId").ToString())) %>'
