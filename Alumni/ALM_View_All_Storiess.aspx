<%@ Page Title="" Language="C#" MasterPageFile="~/Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_View_All_Storiess.aspx.cs" Inherits="Alumni_ALM_View_All_Storiess" %>
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="btn-btm">
                                                        <div class="rs-view-btn">
                                                            <a name="anchStories" href="ALM_StoriessDetails.aspx?id=<%# Eval("encId").ToString() %>">View More </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
