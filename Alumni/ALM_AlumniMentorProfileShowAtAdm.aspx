<%@ Page Title="" Language="C#" MasterPageFile="~/UMM/MasterPage.master" AutoEventWireup="true" CodeFile="ALM_AlumniMentorProfileShowAtAdm.aspx.cs" Inherits="Alumni_ALM_AlumniMentorProfileShowAtAdm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel-body pnl-body-custom">
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            <div class="col-sm-4">
                                <Anthem:DropDownList ID="ddlAlmPrefix" CssClass="form-control" AutoCallBack="true" runat="server" AutoUpdateAfterCallBack="true" Enabled="false" />
                            </div>
                            <div class="col-sm-8">
                                <Anthem:TextBox ID="txtAlumniName" Enabled="false" onkeypress="return AllowAlphabet(event)" runat="server"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            <div class="col-sm-4">
                                <Anthem:DropDownList ID="ddlFPrefix" CssClass="form-control" runat="server" AutoUpdateAfterCallBack="true" Enabled="false" />
                            </div>
                            <div class="col-sm-8">
                                <Anthem:TextBox ID="R_txtFatherName" Enabled="false" onkeypress="return AllowAlphabet(event)" runat="server" AutoUpdateAfterCallBack="True"
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            <div class="col-sm-4">
                                <Anthem:DropDownList ID="ddlMPrefix" CssClass="form-control" runat="server" AutoUpdateAfterCallBack="true" Enabled="false" />
                            </div>
                            <div class="col-sm-8">
                                <Anthem:TextBox ID="R_txtMotherName" Enabled="false" onkeypress="return AllowAlphabet(event)" runat="server" AutoUpdateAfterCallBack="True"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="R_txtPostedDate" Enabled="false" Style="width: 120px !important" runat="server" AutoUpdateAfterCallBack="True" MaxLength="19"
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="E_txtEmail" Enabled="false" CssClass="form-control" runat="server" AutoUpdateAfterCallBack="True" MaxLength="50" TextDuringCallBack="" AutoCallBack="true"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="R_txtContactno" Enabled="false" runat="server" CssClass="form-control" AutoUpdateAfterCallBack="True" MaxLength="10" TextDuringCallBack="" AutoCallBack="true"
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtremarks" Enabled="false" runat="server" CssClass="form-control" MaxLength="500"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtCurrentOccupation" Enabled="false" onkeypress="return AllowAlphabet(event)" ondrop="return false" onpaste="return false" runat="server" AutoUpdateAfterCallBack="True"
                            MaxLength="100" CssClass="form-control" TabIndex="2"></Anthem:TextBox>
                    </div>
                    <label class="col-sm-2 control-label">Designation: </label>
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtDesignation" Enabled="false" onkeypress="return AllowAlphabet(event)" runat="server" AutoUpdateAfterCallBack="True"
                            MaxLength="100" CssClass="form-control" ondrop="return false" onpaste="return false" TabIndex="3"></Anthem:TextBox>
                    </div>
                </div>
            </div>
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtperadd" Enabled="false" runat="server" AutoUpdateAfterCallBack="True" TabIndex="14"
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtCurrentAddress" Enabled="false" runat="server" AutoUpdateAfterCallBack="True"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtsplinterest" Enabled="false" runat="server" CssClass="form-control" MaxLength="500"
                            TextMode="MultiLine" onkeypress="return CheckMaxLength(this,500);" onpaste="event.returnValue=false"
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:TextBox ID="txtachievement" Enabled="false" runat="server" CssClass="form-control" MaxLength="500"
                            TextMode="MultiLine" onkeypress="return CheckMaxLength(this,500);" onpaste="event.returnValue=false"
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:RadioButtonList ID="rdbGender" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdbGender_SelectedIndexChanged" AutoCallBack="true" AutoUpdateAfterCallBack="true" Enabled="false">
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <label class="col-sm-4 control-label custom-text-left">
                        <Anthem:RadioButtonList ID="rdbIsPersonDisability" runat="server" RepeatDirection="Horizontal" AutoCallBack="true" AutoUpdateAfterCallBack="true" TabIndex="19" OnSelectedIndexChanged="rdbIsPersonDisability_SelectedIndexChanged" Enabled="False">
                    ...
                    <Anthem:Panel ID="isChkDisabilityPnl" runat="server" Width="100%" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Visible="false">
                        ...
                        <label class="col-sm-4 control-label custom-text-left">
                            <Anthem:CheckBox ID="isChkDisability" runat="server" OnCheckedChanged="isChkDisability_CheckedChanged" AutoUpdateAfterCallBack="true" AutoCallBack="true" TabIndex="20" Enabled="False" />
                        </label>
                    </Anthem:Panel>
                </div>
            </div>
            <Anthem:Panel ID="disabilitySection" runat="server" Width="100%" AutoUpdateAfterCallBack="True" UpdateAfterCallBack="True" Visible="false" Enabled="False">
                <div class="form-group form-group-sm">
                    <div class="row">
                        <div id="disabilityRemarkSection" runat="server" style="display: none;" updateaftercallback="true">
                            ...
                            <div class="col-sm-4">
                                <Anthem:FileUpload ID="fileDisabilityDoc" TabIndex="22" SkinID="none" runat="server" AutoUpdateAfterCallBack="true" onchange="previewFile()" Enabled="false" />
                                <br />
        ...
        <div class="panel-body pnl-body-custom">
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:DropDownList ID="D_ddlYeofPass" Enabled="false" runat="server" AppendDataBoundItems="True"
                            TabIndex="7" AutoCallBack="True" AutoUpdateAfterCallBack="true" CssClass="form-control"
                            TextDuringCallBack="">
                        </Anthem:DropDownList>*
                    </div>
                    ...
                    <div class="col-sm-4 required">
                        <Anthem:DropDownList ID="ddlDepartment" runat="server" AppendDataBoundItems="True"
                            TabIndex="7" AutoCallBack="True" AutoUpdateAfterCallBack="true" CssClass="form-control"
                            TextDuringCallBack="" Enabled="false">
                        </Anthem:DropDownList>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group form-group-sm">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <asp:FileUpload ID="flUpload" Enabled="false" CssClass="form-control" Style="width: 30% !important;" SkinID="none" runat="server" onchange="previewFile()" />
        ...
        <div class="form-group form-group-sm">
            <div class="row">
                ...
                <div class="col-sm-10 required">
                    <asp:Panel ID="Panel4" Enabled="false" runat="server" Visible="true" AutoUpdateAfterCallBack="true" onchange="previewFile()" EnabledDuringCallBack="false">
                        <asp:FileUpload ID="uploadDocuments" Enabled="false" CssClass="form-control" Style="width: 30% !important;" SkinID="none" runat="server" AutoUpdateAfterCallBack="true" /><br />
    ...
    <fieldset class="fieldset-border">
        ...
        <div class="panel-body pnl-body-custom">
            <div class="form-group form-group-sm">
                <div class="row">
                    <label class="col-sm-2 control-label">Mentor </label>
                    <div class="col-sm-10">
                        <Anthem:CheckBox ID="chkmentor" runat="server" Enabled="true" AutoUpdateAfterCallBack="True" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Anthem:Label ID="lblMentor" runat="server" AutoUpdateAfterCallBack="true" CssClass="lblmessage" Text="* if you want to make alumni act as a mentor then checked the checkbox"></Anthem:Label>
                    </div>
                </div>
            </div>
        </div>
