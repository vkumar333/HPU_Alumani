...
public partial class Alumni_ALM_Comments_Approval_On_Posted_Events : System.Web.UI.Page
{
    ...
    {
        SubSonic.StoredProcedure sp = new SubSonic.StoredProcedure("ALM_Comment_Alumni_Approval_Panding", DataService.GetInstance("IUMSNXG"), "");
        return sp;
    }
    ...
    {
        SubSonic.StoredProcedure sp = new SubSonic.StoredProcedure("ALM_Comment_Alumni_Approval", DataService.GetInstance("IUMSNXG"), "");
        return sp;
    }
    ...
    private void Save()
    {
        DataSet ds = Dobj.GetSchema("ALM_Alumni_Events_Mst_Comments");
        foreach (GridViewRow gr in dgv.Rows)
        {
            CheckBox check = (CheckBox)(gr.FindControl("chkselect"));
            if (check.Checked)
    ...
    {
        SubSonic.StoredProcedure sp = new SubSonic.StoredProcedure("Alm_Alumni_Comment_Approval", DataService.GetInstance("IUMSNXG"), "");
