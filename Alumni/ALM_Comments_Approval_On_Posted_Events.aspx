<%@ Page Title="" Language="C#" MasterPageFile="~/UMM/MasterPage.master" AutoEventWireup="true" CodeFile="ALM_Comments_Approval_On_Posted_Events.aspx.cs" Inherits="Alumni_ALM_Comments_Approval_On_Posted_Events" %>
            ...
            <div class="box box-success">
                <div class="box-body table-responsive">
                    ...
                    <table border="0" style="width: 100%" class="table">
                        <tr>
                            <td colspan="6" class="tableheading">List of Comments Posted On Events Approval Pending </td>
                        </tr>
                        <tr>
                                    ...
                                    <div class="gridiv">
                                        <Anthem:GridView ID="dgv" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageIndex="0" PageSize="10"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Event Name" Visible="True">
                                                    <ItemStyle HorizontalAlign="Center" Width="20%" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCommentedby" runat="server" Text='<%# Eval("Event_name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <tr>
                            <td>
                                <Anthem:Button ID="btnprocess" runat="server" AutoUpdateAfterCallBack="true" Text="PROCESSED" TextDuringCallBack="Wait..." EnabledDuringCallBack="false" OnClick="btnprocess_Click" />&nbsp;
                                <Anthem:Button ID="btnReset" runat="server" AutoUpdateAfterCallBack="true" Text="RESET" TextDuringCallBack="Wait..." EnabledDuringCallBack="false" OnClick="btnReset_Click" />

                                <Anthem:Label ID="lblMsg" runat="server" AutoUpdateAfterCallBack="true" SkinID="lblMsg" Text=""></Anthem:Label>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="box-body table-responsive">
                    ...
                    <table class="table">
                        <tr>
                            <td colspan="6" class="tableheading">List of Approved Comments Posted On Events </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="6">
                                <div style="overflow: scroll; height: 200px;">
