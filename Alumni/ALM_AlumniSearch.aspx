<%@ Page Language="C#" MasterPageFile="../Alumni/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_AlumniSearch.aspx.cs" Inherits="Alumni_ALM_AlumniSearch" Title="Alumni Search" %>
                                        ...
                                        <Anthem:Repeater ID="RepProfile" runat="server" AutoUpdateAfterCallBack="true">
                                            <ItemTemplate>
                                                <div class="col-lg-4 col-md-6 col-xs-6">
                                                    <div onclick="location.href='<%# string.Format("/Alumni/Alm_Alumni_Show_Alumni_Profile_Search.aspx?ID={0}", HttpUtility.UrlEncode(Eval("encId").ToString())) %>';" style="cursor: pointer;">
                                                        <div class="team-item">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-7">
                                                                                        <Anthem:DropDownList ID="ddlRole"
                                                                                            ...
                                                                                            <asp:ListItem Text="Student Chapter" Value="StuCh"></asp:ListItem>
                                                                                        </Anthem:DropDownList>
                                                                                    </div>
                                                                                    <div class="col-md-5">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-7">
                                                                                        <Anthem:DropDownList ID="ddlMembership"
                                                                                            ...
                                                                                            <asp:ListItem Text="Student Chapter Membership" Value="SC"></asp:ListItem>
                                                                                        </Anthem:DropDownList>
                                                                                    </div>
                                                                                    <div class="col-md-5">
