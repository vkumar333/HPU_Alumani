<%@ Page Title="" Language="C#" MasterPageFile="~/AlumniMasterPage.master" AutoEventWireup="true" CodeFile="ALM_Internship_Details.aspx.cs" Inherits="Alumni_ALM_Internship_Details" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="page-title">Internships Details </h1>
                        <div class="back-btn-custom pull-right">
                            <a href="../Alumni/ALM_Published_Internships.aspx">Back</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-success">
                ...
                <div class="panel-body pnl-body-custom">
                    <div class="">
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                <label id="lblStipend" class="col-sm-2 control-label custom-text-right"><span style="font-weight: 600;">Stipend : </span></label>
                                <div class="col-sm-4 required">
                                    <Anthem:TextBox ID="txtStipend" runat="server" MaxLength="250" CssClass="form-control" AutoUpdateAfterCallBack="true" TabIndex="5" Enabled="false"></Anthem:TextBox>
                                </div>
                                <label id="lblDuration" class="col-sm-2 control-label custom-text-right"><span style="font-weight: 600;">Duration : </span></label>
                                <div class="col-sm-4 required">
                                    <Anthem:TextBox ID="txtDuration" runat="server" MaxLength="250" CssClass="form-control" AutoUpdateAfterCallBack="true" TabIndex="6" Enabled="false"></Anthem:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            <div class="row">
                                ...
                                <div class="col-sm-4 required custom-cal">
                                    <Anthem:TextBox ID="V_txtStartDate" runat="server" AutoUpdateAfterCallBack="True" onpaste="return false;" ondrag="return false;" ondrop="return false;" MaxLength="10" onkeydown="return false" CssClass="form-control" TabIndex="8" Width="30%" Enabled="false"></Anthem:TextBox>
                                </div>
                                <label id="lblEndDate" class="col-sm-2 control-label custom-text-right"><span style="font-weight: 600;">Opening To Date : </span></label>
                                <div class="col-sm-4 required custom-cal">
                                    <Anthem:TextBox ID="V_txtEndDate" runat="server" AutoUpdateAfterCallBack="True" onpaste="return false;" ondrag="return false;" ondrop="return false;" MaxLength="10" onkeydown="return false" CssClass="form-control" TabIndex="9" Width="30%" Enabled="false"></Anthem:TextBox>
                                </div>
                            </div>
                        </div>
