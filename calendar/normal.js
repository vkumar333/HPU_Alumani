...
var gcCalBG = "#bcd8e5"; 	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame = "#5ac0f0"; // the background color of the inner table, showing as a frame.
...
var gcSatBG = "#eee"; //"#CBBC91";	// Saturday background color
var gcSun = "black"; // Sunday font color
var gcSunBG = "#eee"; // Sunday background color

var gcOtherDay = "lightgray"; // the font color of days in other months; It's of no use when giShowOther is set to hide.
...
var gcToggle="silver";	// the highlight color for the focused cell
...
var gcBGSelected = "#c6edff";	// the background color for the selected date
