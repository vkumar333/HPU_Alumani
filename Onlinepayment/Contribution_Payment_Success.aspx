<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contribution_Payment_Success.aspx.cs" Inherits="Onlinepayment_Contribution_Payment_Success" %>
            ...
            <div class="empheader">
                ...
                <div class="col-md-6">
                    <ul class="header_pnl_link">
                        <li class="home"><a href="../Alumni/Alm_FundDonationlist.aspx">Home</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="body-content-inside">
                <form id="form1" runat="server">
                    ...
                    <fieldset class="fieldset-formating">
                        <legend><i class="fa fa-fw fa-user"></i>Contribution Payment</legend>
