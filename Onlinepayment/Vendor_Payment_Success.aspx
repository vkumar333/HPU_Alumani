<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor_Payment_Success.aspx.cs" Inherits="Onlinepayment_Vendor_Payment_Success" %>
            ...
            <div class="empheader">
                ...
                <div class="col-md-6">
                    <ul class="header_pnl_link">
                        <li class="home"><a href="../VendorLogin.aspx">Home</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="body-content-inside">
                <form id="form1" runat="server">
                    ...
                    <fieldset class="fieldset-formating">
                        <legend><i class="fa fa-fw fa-user"></i>Vendor Payment</legend>
