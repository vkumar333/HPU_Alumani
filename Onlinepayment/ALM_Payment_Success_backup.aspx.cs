...
public partial class Onlinepayment_ALM_Payment_Success : System.Web.UI.Page
{
    ...
    public void CheckTransactionStatusSBI()
    {
        try
        {
            ...
            string sbi_ref_no = ""; string total_amt = ""; string transaction_id = ""; //our pk_TranId is this
            string status = ""; string status_desc = ""; string checkSum = "";
    ...
    public int PK_PaymentGatewayId { get { return _PK_PaymentGatewayId; } set { _PK_PaymentGatewayId = value; } }
